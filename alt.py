...
def extract_enhanced_features(image_path):
    """
    Enhanced feature extraction with additional image descriptors.
    """
...
def create_models():
    """
    Create model pipelines with predefined hyperparameters, including a semi-supervised decision tree.
    """
...
def train_and_evaluate_models(X_train, y_train, X_val, y_val):
    """
    Train and evaluate models without grid search.
    ...
    # Simulate a semi-supervised scenario by masking 50% of the training labels
    np.random.seed(42)
    ...
    for name, model in models.items():
        ...
        # Get probabilities for ROC curve (if applicable)
        try:
...
def plot_feature_importance(rf_model, gb_model):
    """
    Plot and compare feature importance from Random Forest and Gradient Boosting models.
    """
